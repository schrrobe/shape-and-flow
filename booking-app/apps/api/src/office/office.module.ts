...
import { OfficeAvailabilityController } from './office-availability.controller.js';
...
@Module({
  imports: [
    ...
    InboxModule,
    NotificationModule,
    // For `AvailabilitySnapshotService`, which it exports. The office offers slots from
    // the same loader the reservation transaction re-checks against.
    PublicModule,
  ],
  controllers: [
    DashboardController,
    CalendarController,
    OfficeAvailabilityController,
    EmployeesController,
